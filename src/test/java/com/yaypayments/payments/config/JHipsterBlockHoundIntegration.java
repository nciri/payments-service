...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.yaypayments.payments.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.yaypayments.payments.security.DomainUserDetailsService", "createSpringSecurityUser");
